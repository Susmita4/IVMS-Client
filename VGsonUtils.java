...
public class VGsonUtils {
	...
	public static String getImageBase64(byte[] content) throws IOException {
		return VGsonUtils.BASE64_PREFIX
				+ new String(Base64.encodeBase64(content), UTF8);
	}
	
	public static String getImageBase64(String mimeType, byte[] content) throws IOException {
		if(content == null) {
			return NO_IMAGE_AVAILABLE_BASE64;
		}
		if(StringUtils.isNotEmpty(mimeType)) {
			return StringUtils.join(VGsonUtils.BASE64_PREFIX_1, mimeType, VGsonUtils.BASE64_PREFIX_2)
					+ new String(Base64.encodeBase64(content), UTF8);
		}
		return VGsonUtils.BASE64_PREFIX
				+ new String(Base64.encodeBase64(content), UTF8);
	...
	public static String getImageBase64(String url) throws IOException {
		...
		return VGsonUtils.getImageBase64(content);
	}
}
