...
public class VReturnMessage implements VReturnValues {
	...
	static{
		...
		returnMessage.put(UNABLE_TO_RETRIVED, "Unable to Retrieved!");
		returnMessage.put(UNABLE_TO_PROCESS, "Unable to process! Please check your request parameters!");
		...
		returnMessage.put(CREATE_USER_ID_MISMATCH, "Unable to create user! The userid in url mismatch with payload.");
